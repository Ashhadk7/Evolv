...
export function SidePanel() {
  return (
    <motion.aside
      ...
      className="relative hidden h-screen flex-col overflow-hidden lg:flex lg:w-[44%] xl:w-[42%]"
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 55% at 35% 55%, rgba(137,215,183,0.07) 0%, transparent 65%),radial-gradient(ellipse 50% 40% at 78% 25%, rgba(66,132,117,0.05) 0%, transparent 55%)",
        }}
      />
      <div
      ...
      >
        ...
        <div className="flex flex-1 flex-col justify-center gap-9 py-8">
          <div className="flex flex-col gap-5">
            <div
              className="inline-flex w-fit items-center gap-2 rounded-full px-3 py-1.5 text-[10px] font-bold tracking-widest uppercase"
              style={{
            ...
            <div>
              <h2
                className="leading-[1.08] font-bold tracking-[-0.02em]"
              ...
              <p
                ...
                style={{ color: "rgba(255,244,225,0.46)" }}
              >
                Join a curated ecosystem of founders and developers shipping the next generation of
                startups.
              </p>
            </div>
          </div>
          ...
          >
            <div className="relative flex h-[220px] w-full items-center justify-center xl:h-[260px]">
              <div className="absolute top-1/2 left-1/2 w-[760px] -translate-x-1/2 -translate-y-1/2 scale-[0.55] xl:scale-[0.70]">
