...
export function SignInForm() {
  ...
  return (
    <div
      className="flex w-full flex-col overflow-y-auto lg:w-[50%]"
        ...
        <form onSubmit={handleSignIn} className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <label className="flex cursor-pointer items-center gap-2.5">
              ...
              <span className="text-[12px]" style={{ color: "rgba(15,28,24,0.52)" }}>
                Keep me signed in
              </span>
            </label>
            <a
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px]" style={{ color: "rgba(15,28,24,0.3)" }}>
              or
            </span>
            <div className="h-px flex-1" style={{ background: "rgba(15,28,24,0.08)" }} />
          </div>
          ...
          <button
            ...
            style={{
              background: "#ffffff",
              borderColor: "rgba(15,28,24,0.1)",
              color: "rgba(15,28,24,0.65)",
            }}
          >
