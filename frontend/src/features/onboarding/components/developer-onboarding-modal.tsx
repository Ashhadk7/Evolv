...
import { SkillFlowEditor } from "@/features/onboarding/components/skill-flow-editor";
import { EducationEditor } from "@/features/onboarding/components/onboarding-education-editor";
import { useDeveloperOnboarding } from "@/features/onboarding/lib/use-developer-onboarding";
import { DevStepIdentity } from "./dev-step-identity";
import { DevStepLinks } from "./dev-step-links";
...
export const DevOnboardingModal = ({
  initialProfile,
  onComplete,
  onSkip,
  userName = "",
  ...
  const {
    ...
    handleSkip,
    handleComplete,
  } = useDeveloperOnboarding({ initialProfile, onComplete, onSkip, userName });
