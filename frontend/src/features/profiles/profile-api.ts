...
interface DeveloperWire { job_title: string | null; bio: string | null; experience_years: number | null; github: string | null; linkedin: string | null; portfolio_link: string | null; skills: string[]; profile_complete: boolean; educations: WireEducation[]; certifications: Array<{ id: string; name: string; issuer: string }> }
