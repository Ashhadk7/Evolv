...
export async function loadDeveloperProfile(): Promise<DeveloperProfile> {
  ...
  try {
    ...
    if (!(error instanceof ApiError) || error.status !== 404) throw error;
    data = { job_title: null, bio: null, experience_years: null, availability: true, open_to_remote: false, preferred_budget: null, github: null, linkedin: null, portfolio_link: null, skills: [], tags: [], skill_entries: [], rating_avg: 0, profile_complete: false, educations: [], certifications: [], reviews: [] };
  }
