  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="flex flex-col md:flex-row md:items-center gap-3 bg-white rounded-2xl p-4 border border-[#eaeeed]"
      >
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <p style={{ fontSize: 12.5, color: "#4a6a5a", lineHeight: 1.55, marginBottom: 6 }}>
        ...
        <motion.button
          ...
          className="bp-gradient-btn w-full md:w-auto"
          style={{
            flexShrink: 0,
            padding: "9px 16px",
            borderRadius: 11,
