    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 4px 24px rgba(26,49,44,0.08), 0 1px 4px rgba(26,49,44,0.06)",
        }}
      >
        {/* Window chrome */}
        <div
        ...
        >
          ...
          <span
            ...
            style={{ color: "rgba(26,49,44,0.22)" }}
          >
        ...
        <div className="p-6">
          ...
          <div className="mb-5 flex items-start justify-between gap-4">
            ...
            <div className="text-right">
              <div className="mb-1 text-[10px]" style={{ color: "rgba(15,30,26,0.3)" }}>
                Viability score
              </div>
              <div
                className="text-[2.6rem] leading-none font-bold tabular-nums"
                style={{ color: "#428475" }}
              >
                <AnimatedCounter to={84} duration={1.5} />
              </div>
              <div
                className="mt-1 text-[9px] font-semibold tracking-wider uppercase"
                style={{ color: "rgba(66,132,117,0.6)" }}
              >
                A+ rating
              </div>
            </div>
          ...
          <div className="mb-5 grid grid-cols-2 gap-2.5">
            {[
              ...
              >
                <div
                  className="mb-1 text-[1.2rem] font-bold tabular-nums"
                  style={{ color: "#428475" }}
                >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 text-[11px]">
              <div>
                ...
                {["Strong market demand", "Growing developer interest"].map((s) => (
                  <div
                    key={s}
                    className="mb-1.5 flex items-center gap-1.5"
                    style={{ color: "rgba(15,30,26,0.6)" }}
                  >
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] lg:gap-16">
          ...
          >
            ...
            <h2
              className="mb-5 text-3xl leading-[1.08] font-bold tracking-[-0.02em] sm:text-4xl md:text-[2.8rem]"
              style={{ color: "#0f1e1a" }}
            >
              Your idea, <span style={{ color: "#428475" }}>fully documented</span>
            </h2>
            <p
              className="mb-10 text-[15px] leading-relaxed"
              style={{ color: "rgba(15,30,26,0.5)" }}
            >
              A blueprint is the shared operating document for founders and developers: clear enough
              for execution, detailed enough for due diligence, and structured enough for AI
              matching.
            </p>
