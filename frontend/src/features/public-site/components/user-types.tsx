...
import { ArrowRight, BracketsAngle, Check, LightbulbFilament } from "@phosphor-icons/react";
        ...
        >
          {users.map((user) => (
            <motion.article
              ...
              className="group flex scroll-mt-28 flex-col overflow-hidden rounded-2xl"
              style={{
                background: "#ffffff",
                border: "1px solid rgba(15,30,26,0.07)",
                borderTop: `2.5px solid ${user.accent}`,
                boxShadow: "0 1px 3px rgba(15,30,26,0.04), 0 4px 16px rgba(15,30,26,0.04)",
              }}
            >
              <div className="flex flex-1 flex-col p-7">
                ...
                {/* Title */}
                <h3
                  className="mb-3 text-[1.15rem] leading-snug font-bold tracking-[-0.015em]"
                  style={{ color: "#0f1e1a" }}
                >
                  {user.title}
                </h3>
                ...
                {/* Description */}
                <p className="mb-6 text-sm leading-[1.72]" style={{ color: "rgba(15,30,26,0.5)" }}>
                  {user.description}
                </p>
