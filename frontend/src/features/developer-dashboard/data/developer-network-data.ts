...
export const DEVELOPER_NETWORK_PROFILES: DeveloperContactProfile[] = [
  {
    ...
    highlights: [
      "Series A ready roadmap",
      "Hiring AI and backend talent",
      "Strong clinical workflow focus",
    ],
    online: true,
  },
  {
    ...
    highlights: [
      "Seed stage FinTech build",
      "Clear technical roadmap",
      "Looking for ML and backend support",
    ],
    online: false,
  },
  {
  ...
  },
  {
    ...
    highlights: [
      "MVP stage HealthTech",
      "Hiring technical collaborators",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Open to developer collaborators",
    ],
    online: false,
  },
  {
...
export function buildDeveloperProfileFromContact(contact: {
  ...
  return {
    ...
    focus:
      type === "Founder" ? "Startup execution and hiring" : "Developer collaboration and delivery",
    bio: `${contact.name} is connected through your Evolv conversation context.`,
    highlights: [
      "Active conversation",
      "Shared Evolv network",
      "Profile details available from current context",
    ],
