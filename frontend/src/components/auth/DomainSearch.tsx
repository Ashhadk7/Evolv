...
export function DomainSearch({ selected, onToggle }: { selected: string[]; onToggle: (v: string) => void }) {
  ...
  return (
    <div>
      ...
      {suggestions.length > 0 ? (
        ...
        <p className="text-[12px]" style={{ color: "rgba(15,28,24,0.4)" }}>No domains matched &ldquo;{query}&rdquo;</p>
      ) : null}
    </div>
  );
}
