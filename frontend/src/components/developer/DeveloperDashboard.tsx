    ...
    return (
        <div className={"DeveloperDashboard_dashboardContainer"} suppressHydrationWarning>
            <main className={"DeveloperDashboard_mainWrapper"}>
                ...
                <div className={"DeveloperDashboard_row3"}>
                    ...
                    <div className={"DeveloperDashboard_matchesGrid"}>
                ...
                <div className={"DeveloperDashboard_row4"}>
                    <div className={"DeveloperDashboard_panel"}>
                        <div className={"DeveloperDashboard_panelHeader"}>
                            <span className={"DeveloperDashboard_panelTitle"}>
                                <i className="fas fa-paper-plane"></i> Applications
                            </span>
                            <a href="#" className={"DeveloperDashboard_panelLink"} onClick={(e) => { e.preventDefault(); openModal(MODALS.viewAllApplications); }}>View all →</a>
                        </div>
                    ...
                    <div className={"DeveloperDashboard_panel"}>
                        <div className={"DeveloperDashboard_panelHeader"}>
                            ...
                            <a href="#" className={"DeveloperDashboard_panelLink"} onClick={(e) => { e.preventDefault(); openModal(MODALS.viewAllProjects); }}>View all →</a>
                        </div>
                ...
                <div className={"DeveloperDashboard_footer"}>
                    ...
                    <div className={"DeveloperDashboard_footerRight"}>
    ...
    return (
        <div className={"MatchCard_matchCard"}>
            ...
            <div className={"MatchCard_tags"}>
                {techStack.map((tech, idx) => (
                    <span key={idx} className={"MatchCard_techTag"}>{tech}</span>
                ))}
            </div>
            ...
            <div className={"MatchCard_actions"}>
                <button
                    className={`${"MatchCard_btn"} ${"MatchCard_primary"}`}
                    onClick={() => openModal(MODALS.reviewMatch(data))}
                >
                    <i className="fas fa-eye"></i> Review
                </button>
                <button
                    className={"MatchCard_btn"}
                    onClick={() => openModal(MODALS.saveMatch(data))}
                >
