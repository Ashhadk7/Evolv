...
interface DevNotificationPanelProps {
  isOpen: boolean;
  notifs: DevNotif[];
...
export const DevNotificationPanel = forwardRef<HTMLDivElement, DevNotificationPanelProps>(
  function DevNotificationPanel({ isOpen, notifs, onMarkRead, onMarkAllRead, onNavigate, onClose }, ref) {
                ...
                >
                  {(["all", "unread"] as const).map((tab) => (
                    ...
                    >
                      {notifTab === tab && (
                        <motion.div
                          layoutId="dev-notif-tab-indicator"
                          style={{
                            position: "absolute",
                            inset: 0,
                            borderRadius: 7,
                    ...
                    >
                      {filtered.map((notif, i) => (
                        <motion.button
                          ...
                          className="group w-full text-left flex items-start cursor-pointer font-sans"
                          style={{
                            gap: 12,
                        ...
                        >
                          ...
                          <div style={{ flex: 1, minWidth: 0, textAlign: "left" }}>
                            ...
                            <p style={{ fontSize: 12, color: "#7a9e8e", marginTop: 3, marginBottom: 0, lineHeight: 1.5 }}>
                              {notif.body}
                            </p>
                            <div
                              style={{
