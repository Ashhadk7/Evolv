...
Each objection is an object {text, basis}: set basis to "sourced" only when a research signal genuinely supports it, otherwise "assumption". Do not label a guess as sourced.
