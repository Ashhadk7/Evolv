...
ERROR_STATUS_BY_CODE = {
    ...
    ErrorCode.ALREADY_ENGAGED: status.HTTP_409_CONFLICT,
    ...
    ErrorCode.PROJECT_MEMBER_NOT_FOUND: status.HTTP_404_NOT_FOUND,
    ErrorCode.PROJECT_MEMBER_CONFLICT: status.HTTP_409_CONFLICT,
    ErrorCode.PROJECT_INVALID_PHASE: status.HTTP_422_UNPROCESSABLE_CONTENT,
