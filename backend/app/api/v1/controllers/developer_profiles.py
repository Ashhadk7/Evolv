...
def create_developer_profile(
    payload: DeveloperProfileCreate, db: DbSession, current_user: CurrentDeveloper
) -> DeveloperProfileResponse:
...
def get_my_developer_profile(db: DbSession, current_user: CurrentDeveloper) -> DeveloperProfileResponse:
...
def update_developer_profile(
    payload: DeveloperProfileUpdate, db: DbSession, current_user: CurrentDeveloper
) -> DeveloperProfileResponse:
    return developer_profile_service.update_profile(db, payload, current_user)


@router.delete("", status_code=status.HTTP_204_NO_CONTENT)
def delete_developer_profile(db: DbSession, current_user: CurrentDeveloper) -> None:
